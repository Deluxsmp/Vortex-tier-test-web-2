...
=============================================================== */
const modes=[
 {id:"overall",n:"Overall",i:"🏆",url:""},
 {id:"vanilla",n:"Vanilla",i:"🟪",url:""},
 {id:"uhc",n:"UHC",i:"❤️",url:""},
 {id:"pot",n:"Pot",i:"🧪",url:""},
 {id:"nethop",n:"NetHop",i:"🟣",url:""},
 {id:"smp",n:"SMP",i:"🟢",url:""},
 {id:"sword",n:"Sword",i:"🗡️",url:""},
 {id:"axe",n:"Axe",i:"🪓",url:""},
 {id:"mace",n:"Mace",i:"🔨",url:""}
];

const modeIconById=Object.fromEntries(modes.map(m=>[m.id,m]));
function iconHTML(mode, cls="mode-icon-img"){
  if(mode?.url) return `<img class="${cls}" src="${esc(mode.url)}" alt="${esc(mode.n)}" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='grid'">`;
  return "";
}
function iconFallbackHTML(mode){ return `<span class="icon-fallback">${mode?.i||""}</span>`; }
